...
Namespace VB_RFID3Sample5
    Public Class WriteForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.label1.Size = New Size(&H56, 13)
            ...
            Me.lengthLabel.Location = New Point(&H8D, &H4C)
            Me.lengthLabel.Name = "lengthLabel"
            Me.lengthLabel.Size = New Size(40, &H19)
            ...
            Try
                If ((Not Me.m_AppForm.m_ReaderAPI Is Nothing) AndAlso Me.m_AppForm.m_IsConnected) Then
                    ...
                    If (Me.tagID_TB.Text.Length = 0) Then
                        Me.m_AppForm.notifyUser("No TagID is defined", "Write/BlockWrite Operation")
