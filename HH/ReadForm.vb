...
Namespace VB_RFID3Sample5
    Public Class ReadForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.label1.Size = New Size(&H54, 13)
            ...
            Me.lengthLabel.Location = New Point(&H92, &H4B)
            Me.lengthLabel.Name = "lengthLabel"
            Me.lengthLabel.Size = New Size(40, 30)
            ...
            Me.label2.Size = New Size(&H47, 30)
            ...
            If ((Not Me.m_AppForm.m_ReaderAPI Is Nothing) AndAlso Me.m_AppForm.m_IsConnected) Then
                Try
                    If (Me.tagID_TB.Text.Length = 0) Then
                        Me.m_AppForm.notifyUser("No TagID is defined", "Read Operation")
                    Else
