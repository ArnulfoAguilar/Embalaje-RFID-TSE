...
Namespace VB_RFID3Sample6
    Public Class KillForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.accessFilterButton.Location = New Point(&H51, &H53)
            Me.accessFilterButton.Name = "accessFilterButton"
            Me.accessFilterButton.Size = New Size(&H4B, &H1B)
            Me.accessFilterButton.TabIndex = 3
            ...
            Me.killPwdLabel.Font = New Font("Microsoft Sans Serif", 8!, FontStyle.Regular)
            Me.killPwdLabel.Location = New Point(6, &H33)
            Me.killPwdLabel.Name = "killPwdLabel"
            Me.killPwdLabel.Size = New Size(&H51, &H1D)
            ...
            If ((Not Me.m_AppForm.m_ReaderAPI Is Nothing) AndAlso Me.m_AppForm.m_IsConnected) Then
                Try
                    If ((Me.tagID_TB.Text.Length = 0) AndAlso (Me.m_AppForm.m_AccessFilterForm.getFilter Is Nothing)) Then
                        Me.m_AppForm.notifyUser("No TagID or Access Filter is defined", "Kill Operation")
                        Return
                    End If
