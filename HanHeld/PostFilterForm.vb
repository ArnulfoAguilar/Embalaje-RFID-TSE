...
Namespace VB_RFID3Sample6
    Public Class PostFilterForm
        ...
        Private Sub accessFilterButton_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Try
                If (Me.m_AppForm.m_ReaderAPI.IsConnected AndAlso Me.userFilter_CB.Checked) Then
                    Dim index As Integer
                    If (Nothing Is Me.m_PostFilter) Then
                        Me.m_PostFilter = New PostFilter
                    End If
                    Me.m_PostFilter.MatchPattern = DirectCast(Me.matchPattern_CB.SelectedIndex, MATCH_PATTERN)
                    Me.m_PostFilter.TagPatternA.MemoryBank = DirectCast(Me.memBank_CB1.SelectedIndex, MEMORY_BANK)
                    Me.m_PostFilter.TagPatternA.BitOffset = UInt16.Parse(Me.offset_TB1.Text)
                    exceptionMsg = "TagPatternA Mask:"
                    Dim maskLengthA As UInt16 = (Me.tagMask_TB1.Text.Length / 2)
                    ...
                    Next index
                    Me.m_PostFilter.TagPatternA.TagMask = filterMaskA
                    Me.m_PostFilter.TagPatternA.TagMaskBitCount = (maskLengthA * 8)
                    exceptionMsg = "TagPatternA Pattern:"
                    Dim dataLengthA As UInt16 = (Me.MembankData_TB1.Text.Length / 2)
                    ...
                    Next index
                    Me.m_PostFilter.TagPatternA.TagPattern = memoryBankDataA
                    Me.m_PostFilter.TagPatternA.TagPatternBitCount = (dataLengthA * 8)
                    If (Me.m_PostFilter.MatchPattern <> MATCH_PATTERN.A) Then
                        exceptionMsg = "TagPatternB BitOffset:"
                        Me.m_PostFilter.TagPatternB.MemoryBank = DirectCast(Me.memBank_CB2.SelectedIndex, MEMORY_BANK)
                        Me.m_PostFilter.TagPatternB.BitOffset = UInt16.Parse(Me.offset_TB2.Text)
                        Dim maskLengthB As UInt16 = (Me.tagMask_TB2.Text.Length / 2)
                        ...
                        Next index
                        Me.m_PostFilter.TagPatternB.TagMask = filterMaskB
                        Me.m_PostFilter.TagPatternB.TagMaskBitCount = (maskLengthB * 8)
                        Dim dataLengthB As UInt16 = (Me.MembankData_TB2.Text.Length / 2)
                        ...
                        Next index
                        Me.m_PostFilter.TagPatternB.TagPattern = memoryBankDataB
                        Me.m_PostFilter.TagPatternB.TagPatternBitCount = (dataLengthB * 8)
                    End If
                ElseIf Not Me.userFilter_CB.Checked Then
                    Me.m_PostFilter = Nothing
                End If
                MyBase.Close()
        ...
        Public Function getFilter() As PostFilter
            Return Me.m_PostFilter
        End Function
        ...
        Private Sub InitializeComponent()
            ...
            Me.tabControl1.Size = New Size(240, &H87)
            ...
            Me.filterActionLabel1.Location = New Point(14, 90)
            ...
            Me.MembankData_TB1.Location = New Point(&H5C, &H3D)
            ...
            Me.offsetLabel1.Location = New Point(14, 40)
            ...
            Me.memBank_CB1.Location = New Point(&H5C, 11)
            ...
            Me.memBankLabel1.Location = New Point(14, 13)
            ...
            Me.label2.Location = New Point(14, 90)
            ...
            Me.MembankData_TB2.Location = New Point(&H5C, &H3D)
            ...
            Me.label3.Location = New Point(14, &H42)
            Me.label3.Name = "label3"
            Me.label3.Size = New Size(&H3F, &H18)
            Me.label3.Text = "Tag Pattern"
            Me.offset_TB2.Font = New Font("Microsoft Sans Serif", 8.0!, FontStyle.Regular)
            Me.offset_TB2.Location = New Point(&H5C, &H24)
            ...
            Me.label4.Location = New Point(14, 40)
            ...
            Me.memBank_CB2.Location = New Point(&H5C, 11)
            ...
            Me.label5.Location = New Point(14, 13)
            ...
            Me.matchPattern_CB.Location = New Point(&H53, &H8D)
            Me.matchPattern_CB.Name = "matchPattern_CB"
            Me.matchPattern_CB.Size = New Size(&H51, 20)
            Me.matchPattern_CB.TabIndex = 9
            Me.label1.Font = New Font("Microsoft Sans Serif", 8.0!, FontStyle.Regular)
            Me.label1.Location = New Point(8, &H90)
            Me.label1.Name = "label1"
            Me.label1.Size = New Size(&H4A, 13)
            Me.label1.Text = "Match Pattern"
            Me.accessFilterButton.Location = New Point(&HB6, &HA4)
            Me.accessFilterButton.Name = "accessFilterButton"
            Me.accessFilterButton.Size = New Size(&H33, 20)
            Me.accessFilterButton.TabIndex = 10
            ...
            Me.userFilter_CB.Font = New Font("Microsoft Sans Serif", 8.0!, FontStyle.Regular)
            Me.userFilter_CB.Location = New Point(14, &HA4)
            Me.userFilter_CB.Name = "userFilter_CB"
            Me.userFilter_CB.Size = New Size(100, 20)
            Me.userFilter_CB.TabIndex = 12
            Me.userFilter_CB.Text = "Use Filter"
            AddHandler Me.userFilter_CB.CheckStateChanged, New EventHandler(AddressOf Me.userFilter_CB_CheckStateChanged)
            MyBase.AutoScaleDimensions = New SizeF(96.0!, 96.0!)
            MyBase.AutoScaleMode = AutoScaleMode.Dpi
            Me.AutoScroll = True
            MyBase.ClientSize = New Size(240, &HBC)
            MyBase.Controls.Add(Me.userFilter_CB)
            ...
            MyBase.Name = "PostFilterForm"
            Me.Text = "PostFilter"
            AddHandler MyBase.Closing, New CancelEventHandler(AddressOf Me.PostFilterForm_Closing)
            AddHandler MyBase.Load, New EventHandler(AddressOf Me.PostFilterForm_Load)
        ...
        Private Sub PostFilterForm_Closing(ByVal sender As Object, ByVal e As CancelEventArgs)
        End Sub

        Private Sub PostFilterForm_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Private Sub userFilter_CB_CheckStateChanged(ByVal sender As Object, ByVal e As EventArgs)
            Me.tabControl1.Enabled = Me.userFilter_CB.Checked
        End Sub
        ...
        Private m_PostFilter As PostFilter = Nothing
        ...
        Private userFilter_CB As CheckBox
    End Class
End Namespace
