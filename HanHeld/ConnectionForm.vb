...
Namespace VB_RFID3Sample6
    Public Class ConnectionForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.readerIPLabel.Size = New Size(&H76, 13)
            Me.readerIPLabel.Text = "Host Name/Reader IP"
            Me.connectionButton.Location = New Point(80, &H72)
            ...
            Me.portLabel.Location = New Point(7, &H3A)
            ...
            Me.Port_TB.Location = New Point(&H7E, &H3A)
            ...
            Me.IP_TB.Location = New Point(&H7E, 20)
            Me.IP_TB.Name = "IP_TB"
