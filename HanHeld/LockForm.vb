...
Namespace VB_RFID3Sample6
    Public Class LockForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.label2.Size = New Size(&H5B, 13)
            ...
            Me.tagMaskLabel.Size = New Size(&H49, 13)
            ...
            If ((Not Me.m_AppForm.m_ReaderAPI Is Nothing) AndAlso Me.m_AppForm.m_IsConnected) Then
                Try
                    If ((Me.tagID_TB.Text.Length = 0) AndAlso (Me.m_AppForm.m_AccessFilterForm.getFilter Is Nothing)) Then
                        Me.m_AppForm.notifyUser("No TagID or Access Filter is defined", "Lock Operation")
                        Return
                    End If
                    Me.m_LockParams.AccessPassword = 0
                ...
                Catch ex As Exception
                    Me.m_AppForm.notifyUser(ex.Message, "Lock Operation")
                End Try
