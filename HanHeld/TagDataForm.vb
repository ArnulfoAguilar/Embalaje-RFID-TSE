            ...
            Try
                If (Me.m_AppForm.m_IsConnected AndAlso Not Me.m_IsLoaded) Then
                    If (Me.m_AppForm.inventoryList.SelectedIndices.Count > 0) Then
                        ...
                        Me.m_IsLoaded = True
                    Else
                        Me.m_AppForm.notifyUser("No item is selected", "Tag Data")
                    End If
                Else
                    Me.m_AppForm.notifyUser("Please connect to a reader", "Tag Data")
                End If
            Catch ex As Exception
                Me.m_AppForm.notifyUser(ex.Message, "Tag Data")
            End Try
        End Sub
