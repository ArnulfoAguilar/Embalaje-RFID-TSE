...
/* Created on:     29/10/2018 08:33:36 a.m.                     */
/*==============================================================*/


alter table ARTICULO
   drop constraint FK_ARTICULO_REFERENCE_ESTADOAR;
...
drop table ESTADOARTICULO cascade constraints;
...
/*==============================================================*/
/* Table: ESTADOARTICULO                                        */
/*==============================================================*/
create table ESTADOARTICULO 
(
   ID_EST_ART           INT                  not null,
   DESCRIPCION          VARCHAR2(50),
   constraint PK_ESTADOARTICULO primary key (ID_EST_ART)
);
...
alter table ARTICULO
   add constraint FK_ARTICULO_REFERENCE_ESTADOAR foreign key (ID_EST_ART)
      references ESTADOARTICULO (ID_EST_ART);
